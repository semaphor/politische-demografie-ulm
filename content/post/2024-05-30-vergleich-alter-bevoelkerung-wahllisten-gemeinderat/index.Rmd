---
title: "Vergleich der Altersstruktur von Bevölkerung, Wahllisten und Gemeinderat"
date: 2024-05-30
slug: vergleich-alter-bevoelkerung-wahllisten-gemeinderat
...
<<<<<<< HEAD:content/post/2024-05-30-vergleich-alter-bevoelkerung-wahllisten-gemeinderat/index.Rmd
...
>>>>>>> 7e8682041dded60b887f43751ca77f4bc87a9d8f:overview.Rmd

source("headerGemeinderat2024.R")

```

```{r info-farben, echo=FALSE}
...
Die folgende Grafik (Abbildung \@ref(fig:altersVergleich)) zeigt die Altersverteilung der zur Wahl stehenden Kandidat_innen (in der Mitte) im Vergleich mit der Ulmer Bevölkerung (oben) und dem aktuellen Gemeinderat (unten). Dazu enthalten diese und alle weiteren Grafiken die folgenden Informationen:
...
<<<<<<< HEAD:content/post/2024-05-30-vergleich-alter-bevoelkerung-wahllisten-gemeinderat/index.Rmd
```{r altersVergleich, echo=FALSE, fig.cap='Vergleich Altersverteilung Ulmer Bevölkerung (oben), zur Wahl stehende Kandidat_innen (Mitte) und aktueller Gemeinderat (unten). Jeweils Wahlalter (orange), Altersmedian (blau durchgehend) und Alters-Median Ulmer Bevölkerung (blau gestrichelt)', fig.width=10, fig.asp=0.8, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block;"', echo=FALSE}
=======
```{r altersVergleich, fig.cap='Vergleich Altersverteilung Ulmer Bevölkerung (oben), zur Wahl stehende Kandidat_innen (Mitte) und aktueller Gemeinderat (unten). Jeweils Wahlalter (orange), Altersmedian (blau durchgehend) und Alters-Median Ulmer Bevölkerung (blau gestrichelt)', fig.width=10, fig.asp=0.8, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block;"'}
>>>>>>> 7e8682041dded60b887f43751ca77f4bc87a9d8f:overview.Rmd
...
plotDemografieUlmDistr <- demografieUlm2023Distr %>%
  mutate(Liste = paste0('Ulm\n(n = ', length(demografieUlm2023Distr$Alter), ', MD=', median(Alter), ')')) %>%
...
<<<<<<< HEAD:content/post/2024-05-30-vergleich-alter-bevoelkerung-wahllisten-gemeinderat/index.Rmd
```{r quartile, fig.align = 'center', echo=FALSE}
=======
```{r quartile, fig.align = 'center'}
>>>>>>> 7e8682041dded60b887f43751ca77f4bc87a9d8f:overview.Rmd
...
<<<<<<< HEAD:content/post/2024-05-30-vergleich-alter-bevoelkerung-wahllisten-gemeinderat/index.Rmd
```{r altersVergleichAb16, fig.cap='Vergleich Altersverteilung für Ulmer Bevölkerung >= 16 Jahre (oben), zur Wahl stehende Kandidat_innen (Mitte) und aktueller Gemeinderat (unten). Jeweils mind. Wahlalter (orange), Altersmedian (blauf durchgehend) und Altersmedian Ulmer Bevölkerung (blau gestrichelt)', fig.width=10, fig.asp=0.8, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block;"', echo=FALSE}
=======
```{r altersVergleichAb16, fig.cap='Vergleich Altersverteilung für Ulmer Bevölkerung >= 16 Jahre (oben), zur Wahl stehende Kandidat_innen (Mitte) und aktueller Gemeinderat (unten). Jeweils mind. Wahlalter (orange), Altersmedian (blauf durchgehend) und Altersmedian Ulmer Bevölkerung (blau gestrichelt)', fig.width=10, fig.asp=0.8, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block;"'}
>>>>>>> 7e8682041dded60b887f43751ca77f4bc87a9d8f:overview.Rmd
...
plotDemografieUlmDistrAb16 <- demografieUlm2023Distr[demografieUlm2023Distr$Alter >= 16,] %>%
  mutate(Liste = paste0('Ulm ab 16\n(n = ', length(demografieUlm2023Distr[demografieUlm2023Distr$Alter >= 16,]$Alter), ', MD=', median(Alter), ')')) %>%
  ggplot(aes(x = Alter, y = Liste)) +
  geom_density_ridges_gradient(
    bandwidth = 1.5,
    scale = 45,
...
Für die anstehende Wahl und die Frage wie der Gemeinderat die Bevölkerung altersmäßig repräsentiert wäre interessant zu ermitteln, ob von den zur Wahl stehenden Kandidat:innen in Ulm üblicher Weise überproportional viele der älteren gewählt werden? Dafür liegen öffentlich auffindbar zwar die [Musterstimmzettel von 2019](https://www.ulm.de/-/media/ulm/bd/bd-iv/statistik-und-wahlen/wahlen/kommunalwahl/downloads/sonderveroeffentlichung-gemeinderatwahl-2019.pdf) vor, allerdings enthalten diese im Ggs. zur Bekanntmachung der Wahlvorschläge keine Angabe der Geburtsjahre. Damit kann zur Beantwortung dieser Fragestellung hier leider [aktuell](https://fragdenstaat.de/anfrage/oeffentliche-bekanntmachung-der-wahlvorschlaege-zur-wahl-des-gemeinderats-und-der-ortschaftsraete-am-26-mai-2019/) kein konkreter Vergleich anhand der letzten Wahl präsentiert werden.
...
<<<<<<< HEAD:content/post/2024-05-30-vergleich-alter-bevoelkerung-wahllisten-gemeinderat/index.Rmd
```{r vergleichListen, fig.cap="Vergleich der Alterstruktur der einzelnen Listen mit der Ulmer Gesamtbevölkerung (oben). Geordnet nach Altersmedian.", fig.width=10, fig.asp=1.6, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block;"', echo=FALSE}
=======
```{r vergleichListen, fig.cap="Vergleich der Alterstruktur der einzelnen Listen mit der Ulmer Gesamtbevölkerung (oben). Geordnet nach Altersmedian.", fig.width=10, fig.asp=1.6, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block;"'}
>>>>>>> 7e8682041dded60b887f43751ca77f4bc87a9d8f:overview.Rmd
...
```{r fig.width=10, fig.height=4, fig.align = 'center', warning=FALSE, out.extra='style="display: block; margin: 40px;"', echo=FALSE}
...
```{r fig.width=10, fig.asp=0.5, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block; margin: 40px;"', echo=FALSE}
...
plotOben <- ggarrange(
  ...
  labels = c(NA, NA),
  nrow = 1, ncol = 2,
  widths = c(0, 1) #TODO (nice to have) Verhältnis berechnen.
  )
...
```{r fig.width=10, fig.asp=1.6, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block; margin: 40px;"', echo=FALSE}
...
```{r fig.width=10, fig.asp=0.8, message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.align = 'center', out.extra='style="display: block; margin: 40px;"', echo=FALSE}
...
```{r fig.width=7, fig.asp=0.45, fig.align = 'center', out.extra='style="display: block; margin: 40px;"', echo=FALSE}
