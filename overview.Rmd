...
TODO Motivation:
Anstehende Probleme der nächsten Jahrzehnte: Klimawandel/notwendige -anpassung und Überalterung unserer Gesellschaft (dabei wird auch Ulm erstmal immer älter, bleibt aber eine vergleichsweise junge Stadt [8]).
...
* die bekannt gemachten Wahlvorschläge [1],
* die Zusammensetzung des aktuellen Gemeinderats [4] und 
* zum Vergleich die aktuelle Ulmer Statistik 2023 [2], mit Daten zu den `r length(demografieUlm2023Distr$Alter)` Ulmer:innen [2].
...
* Informationen zur Bevölkerungsentwicklung in Baden-Württemberg finden sich z.B. im Demografieportal des Bundes und der Länder [8].
...
* [8] Themenartikel Baden-Württemberg demografisch, Demografieportal des Bundes und der Länder, Bundesinstitut für Bevölkerungsforschung, [Artikel auf Website](https://www.demografie-portal.de/DE/Politik/Baden-Wuerttemberg/baden-wuerttemberg-demografisch.html)
