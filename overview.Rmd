...
library(ggridges)
extrafont::loadfonts(device="win") # Fix, für ausführung auf Windows.#
...
#options(repr.plot.width = 5, repr.plot.height = 2) 
plotAktRat <- aktRat %>%
  mutate(Fraktion = "Gemeinderat 2019-2024") %>%
...
ggplot(aktRat,  aes(x = Alter, y = NA)) + 
  ...
  #TODO x-Achsen-Marker für Wahlalter und Bevölkerungsmedian.
...
Skizze:
* Angabe im Feld "Beruf oder Stand".
