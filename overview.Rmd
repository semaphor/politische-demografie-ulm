...
subtitle: "ENTWURF | Vergleich Altersstruktur von Bevölkerung, Wahllisten und Gemeinderat"
date: "28.5.2024"
...
Im Vordergrund stehen für viele die Inhalte und Ziele der antretenden Listen bzw. Parteien.
...
Und auf genau diesen Faktor wollen wir hier einen "statistischen Blick" werfen.
Dabei ist jeder Mensch natürlich erstmal sehr inidviudell.
Bei einer größeren Gruppe, wie den 40 am 9. Juni zu wählenden Gemeinderät:innen, kann der Blick in die Statistik aber dabei helfen, sich vor der Stimmangabe ein detaillierteres Bild zu verschaffen.
...
Diese Daten haben wir vor allem bzgl. der Altersstrukturen ausgewertet.
...
Am Ende finden sich natürlich noch Informationen zur Vorgehensweise und den verwendeten Quellen.
Wie möchten mit diesem Bericht dazu einladen selber durch die Darstelungen zu blättern und an den Stellen tiefer reinzuschauen, die dich interessieren.
Die hier zusammengestellten und [frei verfügbaren](https://github.com/semaphor/politische-demografie-ulm) Daten bieten noch weitere Auswertungsmöglichkeiten.
Möglisch scheint uns eine tiefergehende Analyse der beruflichen Hintergründe und evtl. auch Tätigkeiten der Kandidat:innen.
...
Unsere Kontaktdaten findest du ganz unten.
...
Median-Alter, also dem Alter nach in einer Reihe nach aufgestellt, die Person in der Mitte.
...
listen <- listen %>%
  ...
  mutate(Beruf = replace(Beruf, Beruf == "Arzt" | Beruf == 'Ärztin' | Befuf == 'Ärztin i.R.', "Ärzt_in")) %>%
...
Von: Jakob Pietron, Simon Lüke (datalove/UlmAPI und temporärhaus)
