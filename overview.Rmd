...
for (i in seq_along(demografieUlm$Personen)) {
  mittleresAlter <- demografieUlm$Altersgruppe[i] + (demografieUlm$Altersgruppe[i+1] - demografieUlm$Altersgruppe[i+1]) / 2
...
demografieUlmDistr <- as.data.frame(dfU)
...
data <- rbind(data,demografieUlmDistr)
