...
# PLOT ULMER BEVÖLKERUNG versus ALLE KANDIDAT_INNEN (Variante: in einem Plot)
...
```{r fig.width=10, fig.asp=0.5, message=FALSE, warning=FALSE, results='hide', fig.keep='all'}
...
```{r fig.width=10, fig.asp=1.6, echo=FALSE, message=FALSE, warning=FALSE, results='hide', fig.keep='all'}
...
```{r fig.width=10, fig.asp=0.6, message=FALSE, warning=FALSE, results='hide', fig.keep='all'}
